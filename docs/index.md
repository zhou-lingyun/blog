...
features: # 可选的
  - title: 计算机语言
    details: C、C++、Python等语言
    link: /Language/ # 可选
    imgUrl: /img/cat_1.png # 可选   1.png
  - title: 技术
    details: 技术文档、教程、技巧、总结等文章
    link: /technology/
    imgUrl: /img/cat_2.png  # 2.png
  - title: 人工智能
    details: 计算机视觉、自然语言处理
    link: /AI/
    imgUrl: /img/cat_3.png  # 3.png
...
<!-- 小熊猫 -->
<!-- <img src="
g" class="panda no-zoom" style="width: 130px;height: 115px;opacity: 0.8;margin-bottom: -4px;padding-bottom:0;position: fixed;bottom: 0;left: 0.5rem;z-index: 1;"> -->
...
- **WeChat or QQ**: <a href="tencent://message/?uin=894072666&Site=&Menu=yesUrl" class='qq'>1136075877</a>
- **Email**: <a href="mailto:894072666@qq.com">1136075877@qq.com</a>
